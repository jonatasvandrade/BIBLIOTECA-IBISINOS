...
/*	
		...
		$excluir='';
		/*if($codigo!=""){
		$resultado = mysql_query("SELECT * FROM livros WHERE codigo_administrador=".$codigo.";",$conexao);
...
<!--FORM DEFAULT-->
<form id="form_usuarios" name="form_usuarios" action="livros-update.php" target="iframe_usuarios" method="post" onsubmit="javascript: return valida_form();" style="">

	<!--TITULO COM BOTOES-->
	<h2 style="float:left;">livros</h2>
	<a href="livros.php"><button type="submit" class="btn btn-success" value="salvar" id="btn_salvar_top" name="btn" style="float:right;margin-top:17px;margin-right:5px;display:<%=visivel%>;"><i class="icon-ok icon-white"></i>&nbsp;Salvar</button></a>
	<a href="livros.php" class="btn" id="btn_voltar_top" style="float:right;margin-top:17px;margin-right:5px;"><i class="icon-chevron-left icon-dark"></i>&nbsp;Voltar</a>
	<br style="clear:both;">
	<hr><br>
...
<div style="float:left;">
   ...
   <div style="float:left;margin-top:29px;">
	...
	<hr>
	<a href="livros.php"><button type="submit" class="btn btn-success" id="btn_salvar_bottom" value="salvar" name="btn" style="float:right;margin-top:17px;margin-right:5px;display:<%=visivel%>;"><i class="icon-ok icon-white"></i>&nbsp;Salvar</button></a>
	<a href="livros.php"><button type="submit" class="btn btn-success" id="btn_continuar" value="continuar" name="btn" style="float:right;margin-top:17px;margin-right:5px;display:<%=visivel%>;"><i class="icon-ok icon-white"></i>&nbsp;Salvar e continuar</button></a>
	<a href="livros.php"><button type="submit" class="btn btn-success" id="btn_novo" value="novo" name="btn" style="float:right;margin-top:17px;margin-right:5px;display:<%=visivel%>;"><i class="icon-plus icon-white"></i>&nbsp;Salvar e adicionar novo</button></a>
	...
	<a href="livros.php" class="btn" id="btn_voltar_bottom" style="float:right;margin-top:17px;margin-right:5px;"><i class="icon-chevron-left icon-dark"></i>&nbsp;Voltar</a>
...
<div class="modal hidden" id="remove-modal-alert">
	...
	<div class="modal-footer">
		...
		<a id="remove-items-confirm"  class="btn btn-danger"  href="livros-delete.php?codigo=<?php echo '$codigo' ?>" >Sim, remover o item</a>
	</div>
</div>
